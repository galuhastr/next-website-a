    ...
    gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
      ...
      <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
        <Image 
          ...
          height={50}
        />
        <h1 className='bold-52 lg:bold-88 mt-3 text-purple-50'>Moyo Island</h1>
        <p className='regular-16 mt-5 text-gray-30 xl:max-w-[520px]'>
      ...
      <div className='relative flex flex-1 items-start'>
        ...
        rounded-3xl bg-green-90 px-7 py-8'>
            ...
            <div className='flex flex-col'>
              ...
              <p className='bold-20 text-white'>Nusa Tenggara Barat</p>
            </div>

            <div className='flexBetween'>
              <div className='flex flex-col'>
                <p className='regular-16 block text-gray-20'>Distance</p>
                <p className='bold-20 text-white'>1,195 km</p> 
              </div>
              <div className='flex flex-col'>
                <p className='regular-16 block text-gray-20'>Area</p>
                <p className='bold-20 text-white'>349 km2</p> 
              </div>
            </div>
